...
PrettyJSON.tpl.Node = '' + '<span class="node-container">' + '<span class="node-top node-bracket" style="cursor:pointer" />' + '<span class="node-content-wrapper">' + '<ul class="node-body" />' + '</span>' + '<span class="node-down node-bracket" style="cursor:pointer" />' + '</span>';
PrettyJSON.tpl.Leaf = '' + '<span class="leaf-container">' + '<span class="<%= type %>"> <%=data%></span><span><%= coma %></span>' + '</span>';
PrettyJSON.view.Node = Marionette.ItemView.extend({
    tagName: 'span',
    data: null,
    level: 1,
    path: '',
...
PrettyJSON.view.Leaf = Marionette.ItemView.extend({
    tagName: 'span',
    data: null,
    level: 0,
    path: '',
